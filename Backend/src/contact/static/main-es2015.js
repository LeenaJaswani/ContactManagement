...
let ApiService = class ApiService {
    ...
    updateContact(contact) {
        ...
        return this.http.put(this.baseurl + contact.id + '/', body, { headers: this.httpHeaders });
    }
    addContact(contact) {
        const body = { Name: contact.Name, EmailAddress: contact.EmailAddress, ContactNumber: contact.ContactNumber, HomeAddress: contact.HomeAddress, Birthday: contact.Birthday, Nickname: contact.Nickname };
...
let AppComponent = class AppComponent {
    constructor(api) {
        ...
        this.addContact = () => {
            this.api.addContact(this.newContact).subscribe(data => {
...
module.exports = __webpack_require__(/*! F:\ContactManagement\public\frontend\frontcontact\src\main.ts */"./src/main.ts");
